				...
				<section role="main" class="content-body">
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							...
							<ol class="breadcrumbs">
								...
								<li><span>Create Employee Registration&nbsp;&nbsp;</span></li>
					...
					<div class="row">
						...
						<div class="col-md-12">
								...
								<form id="form"  method="POST" action="employee_registration_code.php" class="form-horizontal" enctype="multipart/form-data" onSubmit="disable();">

								<section class="panel">

									<header class="panel-heading">

										<h2 class="panel-title">Create Employee Registration</h2>
									...
									<div class="panel-body">
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												...
												<input type="text" name="fullname" id="fullname" maxlength="100" class="form-control" required />
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												...
												{
												?>
												<option value="<?php echo $rowDesignation['id'];?>"><?php echo $rowDesignation['designation'];?></option>	
												<?php }?>
											</select>
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												...
												<div class="input-group">
													...
													<input type="text" name="phone" id="phone"  onKeyPress="return isNumber(event,'phone')" maxlength="10" class="form-control" />
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												...
												<div class="input-group">
													...
													<input type="date" name="doj" id="doj" value="" maxlength="30"   class="form-control">
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												...
												<input type="text" name="empsalary" id="empsalary" onKeyPress="return isNumber(event,'empsalary')" value="" maxlength="10" class="form-control" /><!--required-->
											...
											<div class="col-sm-8">
												...
												<div class="input-group">
													...
													<span class="input-group-addon">
                                                  	...
                                                  	<input type="date" name="dob" id="dob"  maxlength="30"  class="form-control"><!--required-->
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												...
												<input type="text" name="idnumber" value="0" id="idnumber" maxlength="100" class="form-control" required />
