...
$resultEmply = mysqli_query($con, "SELECT * FROM employee_registration where currentStatus='Y'");

$userid = $_GET['type'];
$resultUser = mysqli_query($con, "select * from users  where id = '".$userid."'");
...
<html class="fixed">
	...
	<head>
		...
		<meta charset="utf-8">
		 ...
		 <title    <title>Zero Diabetic Diet | Consultancy </title>
...
<input type="hidden"  name="userid" id="userid" value="<?php echo $rowUsers['id']; ?>" />
								<section class="panel">
										...
										<div class="form-group col-sm-6">
											...
											<select id="employee_id" name="employee_id" class="form-control" required >
												...
												<option value="">Select</option>
                                                 <?php 
												while($rowEmploy = mysqli_fetch_array($resultEmply))
												{
												?>
												<option value="<?php echo $rowEmploy['id'];?>"<?php if($rowEmploy['id'] == $rowUsers['empid']) { echo "selected='selected'";}?>><?php echo $rowEmploy['fullname'];?></option>	
												<?php }?>
											</select>
						...
						<input type="text" required name="userName" id="userName" maxlength="100"  class="form-control input-lg" value="<?php echo $rowUsers['userName']; ?>" />
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												...
												<input type="password" required name="passWord" id="passWord" maxlength="100" class="form-control" value="<?php echo $rowUsers['userName']; ?>"/>
											...
											<div class="col-sm-8">
												...
												<input type="password" required name="cpassword" id="cpassword" maxlength="100" class="form-control" value="" />
											</div>
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												...
												<div class="input-group">
                                                        ...
                                                        <option value="1" <?php if($rowUsers['role'] == "1") { echo "selected='selected'";}?>>Administrator</option>
                                                        <option value="2" <?php if($rowUsers['role'] == "2") { echo "selected='selected'";}?>>Admin</option>
                                                        <option value="3" <?php if($rowUsers['role'] == "3") { echo "selected='selected'";}?>>Employe</option>
									...
									<footer class="panel-footer">
										...
										<div class="row">
											...
											<div class="col-sm-12 col-sm-offset-5">
												...
												<button type="submit" name="Update" id="Update" class="btn btn-warning">Save</button>
