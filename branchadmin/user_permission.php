					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							...
							<ol class="breadcrumbs">
								...
								<li><span> User Permission&nbsp;&nbsp;</span></li>
								...
								<div class="form-group col-sm-6">
										...
										<label class="col-sm-4 control-label">Menu <span class="required">*</span></label>
											...
											<div class="col-sm-8">
												...
												<option value=""><b>Select Menu</b></option>
                                                 <option value="1">Manage Customer</option>
                                                 <option value="2">Manage  Executive </option>
                                                  <option value="3">Employee Registration</option>
                                                  <option value="4"> Loan Application</option>
                                                 <option value="5"> User Privileges </option>
                                                  <option value="6">Executive’s Promotions</option>
                                                  <option value="7"> Executive Advances</option>
                                                 <option value="8">Manage  Birthday  </option>
                                                  <option value="9"> Whatsapp  Massage Send</option>
                                                  <option value="10">  Manage Feedback</option>
                                                 <option value="11">Manage Notifications </option>
                                                  <option value="12"> Receipts</option>
                                                  <option value="13"> Commissions</option>
                                                 <option value="14">View Network Tree </option>
                                                  <option value="15">View Executive Wise Tree</option>
                                                  <option value="16">Daily Executive Report </option>
                                                 <option value="17"> Monthly Executive Report  </option>
                                                  <option value="18"> Yearly Executive Report</option>
									...
									<footer class="panel-footer">
										...
										<div class="row">
											...
											<div class="col-sm-12 col-sm-offset-5">
												...
												<button type="button" onClick="window.location.href='manage_permission.php'" name="" class="btn btn-default">Back</button>
