...
$resultBirthday = mysqli_query($con, "SELECT * FROM customer_registration");
//$resultBirthday = mysqli_query($con, "SELECT * FROM customer_registration where date_of_birth = '".$dateofbirth."'");
...
<?php include "left.php"; ?>
                ...
                <section role="main" class="content-body">
                    ...
                    <section class="panel">                         
                        ...
                        <form method="post" id="form" action="whatsapp_message_code.php" onSubmit="return disable_sendall();" name="form">
