...
&nbsp;&nbsp;
							<div style="border-bottom: dotted;"></div></td>
									</tr>
                                    <tr>
									   <td colspan="2" align="center"><img src="assets/images/noimage.jpg" width="100" height="100" class="fix-size" id="profileimage" /> </td>
										
										<td colspan="2">
                                        <table class="table"><tr><td>Date:</td><td><?php echo date("d-m-Y");?></td></tr>
                                        <tr><td>Employee ID::</td><td><?php echo $rowQgl['emp_id'];?></td></tr>
                                        <tr><td>Full Name:</td><td><?php echo $name =  ucfirst($rowQgl['fullname']);?></td></tr>
                                    ...
                                    <tr>
									   <td>Staff Type: </td>
										<td>  <?php 
												 ...
												 ?></td>
										<td>Gender</td>
										<td><?php if($rowQgl['gender'] == 'M'){echo "Male";} else {echo "Female";};?>	</td>
									</tr>
                                    <tr>
									   <td>Email: </td>
										<td>	<?php echo $rowQgl['emailid'];?></td>
										<td>City:</td>
										<td><?php echo $rowQgl['city'];?></td>
									</tr>
                                     <tr>
									   <td>State: </td>
										<td><?php 
                                     ...
                                     <tr>
									   <td>Date of Join: </td>
										<td><?php 
												...
												?></td>
										<td>Salary:</td>
										<td><?php echo $rowQgl['empsalary'];?></td>
									</tr>
                                     <tr>
									   <td>Date of Birth: </td>
										<td><?php 
                                     ...
                                     <tr>
									   <td>ID proof Type: </td>
										...
										<td>	<?php echo $rowQgl['idnumber'];?></td>
									</tr>
