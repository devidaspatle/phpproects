...
<?php include "left.php"; ?>
				...
				<section role="main" class="content-body">
					...
					<header class="page-header">
						...
						<h2>Edit Employee Registration</h2>
						...
						<div class="right-wrapper pull-right">
							...
							<ol class="breadcrumbs">
								...
								<li><span>Edit Employee Registration&nbsp;&nbsp;</span></li>
						...
						<div class="col-md-12">
								...
								<section class="panel">
									...
									<header class="panel-heading">
										...
										<h2 class="panel-title">Edit Employee Registration</h2>
									...
									<div class="panel-body">
										...
										<div class="form-group col-sm-6">
											...
											<label class="col-sm-4 control-label">Profile Picture <!--<span class="required">*</span>--></label>
											...
											<div class="col-sm-8 text-center">
				                                ...
				                                <div class="btn btn-primary mt-lg" id="uploadprofile" >
										...
										<div class="form-group col-sm-6">
											...
											<label class="col-sm-4 control-label">Full Name <span class="required">*</span></label>

											<div class="col-sm-8">

												<input type="text" name="fullname" id="fullname" maxlength="100" class="form-control" required value="<?php echo $rowQgl['fullname'];?>" />
										...
										<div class="form-group col-sm-6">
											...
											<label class="col-sm-4 control-label">Staff Type <span class="required">*</span></label>
											...
											<div class="col-sm-8">
												...
												{
												?>
												<option value="<?php echo $rowDesignation['id'];?>"<?php if($rowDesignation['id'] == $rowQgl['stafftype']) { echo "selected='selected'";}?>><?php echo $rowDesignation['designation'];?></option>	
												<?php }?>
											</select>
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												...
												<select id="gender" name="gender" class="form-control" >
													...
													<option value="M" <?php if($rowQgl['gender'] == "M") { echo "selected='selected'";}?>>Male</option>

													<option value="F" <?php if($rowQgl['gender'] == "F") { echo "selected='selected'";}?>>Female</option>
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												...
												<div class="input-group">
													...
													<input type="email"  name="emailid" id="emailid" onChange="check_mail_id()" maxlength="100" class="form-control" value="<?php echo $rowQgl['emailid'];?>" /><!--required-->

												</div>

                                                <span id="response1" style="color:red;"></span><br>
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												...
												<input type="text" required name="city" id="city" maxlength="100" class="form-control" value="<?php echo $rowQgl['city'];?>" />
											...
											<select id="state" name="state" class="form-control" required >
												...
												{
												?>
												<option value="<?php echo $rowState['sta_id'];?>"<?php if($rowState['sta_id'] == $rowQgl['state']) { echo "selected='selected'";}?>><?php echo $rowState['sta_name'];?></option>	
												<?php }?>
											</select>
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												...
												<div class="input-group">
													...
													<input type="text" name="phone" id="phone"  onKeyPress="return isNumber(event,'phone')" maxlength="10" class="form-control"  required value="<?php echo $rowQgl['phone'];?>"/>
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												...
												<div class="input-group">
													...
													<input type="date" name="doj" id="doj" maxlength="30" required  class="form-control" value="<?php echo $rowQgl['doj'];?>">
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												...
												<input type="text" name="empsalary" id="empsalary" onKeyPress="return isNumber(event,'empsalary')" value="<?php echo $rowQgl['empsalary'];?>" maxlength="12" class="form-control" /><!--required-->
											...
											<div class="col-sm-8">
												...
												<div class="input-group">
													...
													<span class="input-group-addon">
                                                  	...
                                                  	<input type="date" name="dob" id="dob"  maxlength="30"  class="form-control" value="<?php echo $rowQgl['dob'];?>"><!--required-->
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												...
												<textarea name="address" id="address" rows="2" class="form-control"><?php echo $rowQgl['address'];?></textarea>
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												...
												<input type="text" name="idnumber" value="<?php echo $rowQgl['idnumber'];?>" id="idnumber" maxlength="100" class="form-control" required  />
