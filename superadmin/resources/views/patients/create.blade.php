...
<div class="col-md-6">
       ...
       <div class="col-md-6">
        ...
        <div class="form-group">
          ...
          <label for="Age">Age:</label>
           ...
           <input type="text" name="age" id="age"  value="0" maxlength="3" class="form-control" />
       ...
       <div class="col-md-6">
        ...
        <div class="form-group">
          ...
          <input type="date" name="date_of_birth" id="date_of_birth"  maxlength="30"  class="form-control">
    ...
    <div class="col-md-6">
     ...
     <div class="col-md-4">
        ...
        <div class="form-group">
          ...
          <label for="Weight">Appropriate Diet Therapy Centre :</label>
    ...
    <div class="col-md-4">
       ...
       <div class="col-md-4">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="consaltancy" id="consaltancy"/>
