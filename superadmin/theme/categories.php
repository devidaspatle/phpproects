   ...
   <div style=" border-bottom:background: #fff;border-bottom: 1px solid #000;">
    ...
    <div id="content" class="content_home">
        ...
        <div class="so-page-builder">
            ...
            <div class="container page-builder-ltr">
                ...
                <div class="section-title text-center">
                    <h3 style="text-transform: uppercase;">Categories</h3>
        ...
        <div class="newsletter_area">
            <div class="col-md-12">
            <?php
             $sqlcat = "SELECT * FROM categories where status ='1'";
                 $resultcat = mysqli_query($conn, $sqlcat);
                if (mysqli_num_rows($resultcat) > 0) {
                while($rowcats = mysqli_fetch_assoc($resultcat)) {
             ?>
                <div class="col-md-3" style="padding-bottom:20px;"> <a href="subcategories.php?catid=<?php echo $rowcats['id'];?>" >    <img src="../public/category/<?php echo $rowcats['image'];?>" alt="<?php echo $rowcats['category'];?>" title="<?php echo $rowcats['category'];?>" class="img-responsive" style="width: 220px; height: 200px;border:1px solid #f6d7c3; text-align: center;"/> <h5 style="text-align: center;"><?php echo $rowcats['category'];?></h5></a>
