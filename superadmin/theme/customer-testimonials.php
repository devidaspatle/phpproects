<?php
    ...
    $sqltestimonial = "SELECT * FROM testimonials where status =1";
    $results = mysqli_query($conn, $sqltestimonial);               
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Ashtvinayak Gold: Customer Testimonials</title>
    <base />
            ...
            <div class="container page-builder-ltr">
                ...
                ?>
                 <div class="col-md-12" style="text-align: justify;">
                   <div class="col-md-2"> <img src="../public/testimonial/<?php echo $rows['image']?>" class="img-responsive" style="width: 160px; height: 170px; text-align: left;; padding-top:30px;"> </div>
               <div class="col-md-10">  <h3><?php echo ucwords($rows['title']);?></h3>
