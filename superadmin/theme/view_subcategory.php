...
include("includes/config.php");
    ...
    $sqlcat = "SELECT * FROM categories where id ='$catsid' and type_menu='1'";
    ...
    <body class="product-product-34">
       ...
       <div class="container">
        <ul class="breadcrumb">
            ...
            <li><a href="#"><?php echo ucwords($rowcats['category']); ?></a></li>
        </ul>
        <div class="row">
            <aside id="column-left" class="col-sm-3 hidden-xs">
                <div class="list-group">
                    ...
                    <?php
                      $sqlcat = "SELECT * FROM categories where status ='1' and type_menu='1' group by id";
                         $resultcat = mysqli_query($conn, $sqlcat);
                        if (mysqli_num_rows($resultcat) > 0) {
                        while($rowcat = mysqli_fetch_assoc($resultcat)) {
                            $catid = $rowcat['id'];
                           
                            $sqlproducts = "SELECT * FROM products where  type_menu='1' and status =1 and categoryid ='$catid'";
                     ...
                     ?>
                      ...
                      <?php 
                      $sqlsubcats = "SELECT * FROM subcategories where categoryid ='$catid' and type_menu='1'";
                            $resultsubcats = mysqli_query($conn, $sqlsubcats);
                           while($rowsubcates = mysqli_fetch_assoc($resultsubcats)){
                            $subcatids = $rowsubcates['id']; 
                            $sqlsubproducts = "SELECT * FROM products where  type_menu='1' and status =1 and categoryid ='$catid' and subcategoryid = $subcatids";
                            $resultsubproducts = mysqli_query($conn, $sqlsubproducts);
                            $numsubproduct =  mysqli_num_rows($resultsubproducts);
                            ?>
                      <a href="view_subcategory.php?subcat=<?php echo $rowsubcates['id'];?>" class="list-group-item">&nbsp;&nbsp;&nbsp;- <?php echo $rowsubcates['subcategory'];?>(<?php echo $numsubproduct; ?>)</a>
          ...
          Refine Search
                ...
                <div class="category_filter">
                 ...
                 <button type="button" id="list-view" class="btn btn-default list" data-toggle="tooltip" title="List">
