...
<body class="common-home">
    ...
    <div id="content" class="content_home">
        ...
        <div class="so-page-builder">
            ...
            <div class="container page-builder-ltr">
                 <div class="col-md-12" style="text-align: justify;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</div>
            </div>
        </div>
 ...
 <div class="col-md-12" style="text-align: justify;">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</div>
 <div class="col-md-12">&nbsp;</div>
            ...
            <div class="container">
               <div class="col-md-4" style="text-align: center;">
               	<img style="border:5px solid #f6d7c3" src="image/avtar.png" alt="" />
               	 <h4>Test 1</h4>
                </div>
               <div class="col-md-4" style="text-align: center;">
               	<img style="border:5px solid #f6d7c3" src="image/avtar.png" alt="" />
 ...
 <div class="container">
        ...
        <div class="newsletter_area">
        <?php include "newsletter.blade.php" ?>
        </div>
