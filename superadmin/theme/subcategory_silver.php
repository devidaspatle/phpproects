...
include("includes/config.php");
    error_reporting(0);
    $catsid = $_GET['catid'];
    $sqlsubcat = "SELECT * FROM categories where id ='$catsid' and type_menu='2'";
...
<head>
    ...
    <title>Ashtvinayak Gold: Silver</title>
    <base />
        ...
        <ul class="group">
         ...
         <h5 style="padding:5px; text-transform: uppercase;">Product Type</h5>
           <ul class="group">
             ...
             ?>
              <li><label class=" listing__checkbox chk"> <input type="checkbox">&nbsp;<?php echo $rowcat['category'];?></label></li>
              <?php } } ?>
           </ul>
            </div>
             ...
             <div class="col-md-9">
            <?php
              $sqlsubcat = "SELECT * FROM subcategories where categoryid ='$catsid' and type_menu='2'";
                 $resultsubcat = mysqli_query($conn, $sqlsubcat);
                if (mysqli_num_rows($resultsubcat) > 0) {
                while($rowsubcats = mysqli_fetch_assoc($resultsubcat)) {
             ?>
                <div class="col-md-3" style="padding-bottom:20px;"> <a href="product_details.php?productid=<?php echo $rowsubcats['id'];?>&subcat=<?php echo $subcatid;?>">    <img src="admin_panel/subcategory/<?php echo $rowsubcats['image'];?>" alt="<?php echo $rowsubcats['subcategory'];?>" title="<?php echo $rowsubcats['subcategory'];?>" class="img-responsive"style="width: 250px; height: 225px;border:1px solid #f6d7c3; text-align: center;" /> </a>
            <a href="product_details.php?productid=<?php echo $rowsubcats['id'];?>">  <div align="center"><?php echo $rowsubcats['subcategory'];?></div></a>
                </div>
