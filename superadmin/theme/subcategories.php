<?php
    ...
    error_reporting(0);
    $catsid = $_GET['catid'];
    $sqlcat = "SELECT * FROM categories where id ='$catsid'";
...
<head>
    ...
    <title>Ashtvinayak Gold : Subcategories</title>
    <base />
    ...
    <div id="content" class="content_home">
        ...
        <div class="so-page-builder">
            ...
            <div class="container page-builder-ltr">
                ...
                <div class="section-title text-center">
                    ...
                    <h3 style="text-transform: uppercase;"><?php echo $rowcats['category'];?></h3>
                     <center>
        ...
        <div class="newsletter_area">
            ...
            <?php
                ...
                $sqlsubcat = "SELECT * FROM subcategories where categoryid = '$catsid' and status ='1'";
                 $resultsubcat = mysqli_query($conn, $sqlsubcat);
                if (mysqli_num_rows($resultsubcat) > 0) {
                while($rowsubcats = mysqli_fetch_array($resultsubcat)) {
                    $typemenu = $rowsubcats['type_menu'];
                    if($typemenu==1)
                    {
             ?>
                <div class="col-md-3" style="padding-bottom:20px;"> <a href="view_subcategory.php?subcatid=<?php echo $rowsubcats['id'];?>" >    <img src="../public/subcategory/<?php echo $rowsubcats['image'];?>" alt="<?php echo $rowsubcats['category'];?>" title="<?php echo $rowsubcats['category'];?>" class="img-responsive" style="width: 220px; height: 200px;border:1px solid #f6d7c3; text-align: center;"/> <h5 style="text-align: center;"><?php echo $rowsubcats['subcategory'];?></h5></a>
                </div>
        <?php } else { ?>
        <div class="col-md-3" style="padding-bottom:20px;"> <a href="view_silver_subcategory.php?subcatid=<?php echo $rowsubcats['id'];?>" >    <img src="../public/subcategory/<?php echo $rowsubcats['image'];?>" alt="<?php echo $rowsubcats['category'];?>" title="<?php echo $rowsubcats['category'];?>" class="img-responsive" style="width: 220px; height: 200px;border:1px solid #f6d7c3; text-align: center;"/> <h5 style="text-align: center;"><?php echo $rowsubcats['subcategory'];?></h5></a>
                </div>
    <?php } ?>
              <?php } } ?>
